...
This module contains an implementation of the Subscription client W3C [**WebSub**](https://www.w3.org/TR/websub/) recommendation, which facilitates a push-based content delivery/notification mechanism between publishers and subscribers.

This package includes only Subscriber: A party interested in receiving update notifications for particular topics.

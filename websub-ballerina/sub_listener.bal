...
public class Listener {
    ...
    private isolated function retrieveServicePath(string[]|string? name) returns string[]|string {
        if (name is ()) {
    ...
    private isolated function logGeneratedCallbackUrl(string[]|string? name, string callbackUrl) {
        if (name is ()) {

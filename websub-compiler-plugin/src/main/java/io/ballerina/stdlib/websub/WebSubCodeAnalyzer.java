...
import io.ballerina.stdlib.websub.validator.ServiceAnnotationValidator;
...
public class WebSubCodeAnalyzer extends CodeAnalyzer {
    ...
    public void init(CodeAnalysisContext codeAnalysisContext) {
        ...
        codeAnalysisContext.addSyntaxNodeAnalysisTask(
                new ServiceAnnotationValidator(), SyntaxKind.SERVICE_DECLARATION);
        codeAnalysisContext.addSyntaxNodeAnalysisTask(
                new ServiceRequiredMethodValidator(), SyntaxKind.SERVICE_DECLARATION);
    }
}

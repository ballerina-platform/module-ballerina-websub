...
# + additionalParams - Additional parameters which needs to be sent with the subscription request
# + additionalHeaders - Additional HTTP headers which needs to be sent with the subscription request
